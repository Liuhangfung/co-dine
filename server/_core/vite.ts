...
export async function setupVite(app: Express, server: Server) {
  ...
  app.use("*", async (req, res, next) => {
    ...
    try {
      ...
      // Replace env vars with defaults if not set
      const envVars = {
        VITE_APP_LOGO: process.env.VITE_APP_LOGO || '/favicon.ico',
        VITE_APP_TITLE: process.env.VITE_APP_TITLE || 'Healthy Recipe Manager',
